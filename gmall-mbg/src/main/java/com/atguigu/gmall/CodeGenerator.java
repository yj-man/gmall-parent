...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\Myxiangmu\\谷粒商城\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("yj");
        ...
        dsc.setUrl("jdbc:mysql://192.168.101.129:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
